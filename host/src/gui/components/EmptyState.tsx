    ...
    return (
        <div className="flex flex-col items-center justify-center h-full text-[var(--color-text-tertiary)] select-none pointer-events-none">
             <div className="flex flex-col items-center gap-4 opacity-40">
                <div className="w-16 h-16 rounded-full border border-dashed border-[var(--color-text-tertiary)] flex items-center justify-center animate-[spin_10s_linear_infinite]">
