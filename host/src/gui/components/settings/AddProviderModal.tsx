                ...
                <div className="flex flex-col gap-5 p-6 sm:p-7 overflow-y-auto custom-scrollbar">
                                ...
                                >
                                    <div className="p-2 border-b border-[var(--color-border)]">
                                        <input
                                            ...
                                            className="w-full h-8 px-3 rounded-md bg-[var(--color-bg-surface)] border border-[var(--color-border)] text-sm text-[var(--color-text-primary)] placeholder:text-[var(--color-text-muted)] focus:outline-none focus:border-[var(--color-primary)]"
                                        />
                                    </div>
                                    <div className="max-h-[168px] overflow-y-auto">
                                        {filteredProviders.length === 0 && (
                                            <div className="px-3 py-2 text-xs text-[var(--color-text-muted)]">No providers found</div>
                                        )}
                    ...
                    {selectedProviderId && (
                        <div className="flex flex-col gap-2" ref={modelDropdownRef}>
                            ...
                            {isLoadingModels ? (
                                <div className="px-4 py-3 rounded-lg border border-[var(--color-border)] bg-[var(--color-bg-elevated)] text-[var(--color-text-muted)] text-sm">
                                    Loading models...
                                </div>
                                ...
                                <div className="relative">
                                    ...
                                    >
                                        <span className={`text-sm truncate ${model ? 'text-[var(--color-text-primary)]' : 'text-[var(--color-text-muted)]'}`}>
                                        ...
                                        <div className="absolute bottom-full left-0 right-0 mb-2 rounded-[var(--r-panel)] border border-[var(--lg-border)] bg-[var(--lg-bg)] backdrop-blur-xl shadow-xl z-[70] overflow-hidden">
                                            ...
                                            <div className="max-h-[168px] overflow-y-auto">
                                                ...
                                                {filteredModels.length === 0 && (
                                                    <div className="px-3 py-2 text-xs text-[var(--color-text-muted)]">No models found</div>
                                                )}
