...
var outputItemSchema = z4.discriminatedUnion("type", [
  ...
  z4.object({
    type: z4.literal("file_search_call"),
    id: z4.string(),
    status: z4.string(),
    queries: z4.array(z4.string()).optional(),
    results: z4.array(
      z4.object({
        file_id: z4.string(),
        filename: z4.string(),
...
var xaiResponsesChunkSchema = z4.union([
  ...
  z4.object({
    type: z4.literal("response.file_search_call.in_progress"),
    item_id: z4.string(),
    output_index: z4.number()
  }),
  z4.object({
    type: z4.literal("response.file_search_call.searching"),
    item_id: z4.string(),
    output_index: z4.number()
  }),
  z4.object({
    type: z4.literal("response.file_search_call.completed"),
    item_id: z4.string(),
    output_index: z4.number()
  }),
  z4.object({
...
var xaiResponsesProviderOptions = z5.object({
   ...
   */
  include: z5.array(z5.enum(["file_search_call.results"])).nullish()
});
...
var fileSearchArgsSchema = lazySchema(
  () => zodSchema(
    z6.object({
      vectorStoreIds: z6.array(z6.string()),
      maxNumResults: z6.number().optional()
    })
  )
);
...
var mcpServerArgsSchema = lazySchema2(
  () => zodSchema2(
    z7.object({
      serverUrl: z7.string().describe("The URL of the MCP server"),
      serverLabel: z7.string().optional().describe("A label for the MCP server"),
      serverDescription: z7.string().optional().describe("Description of the MCP server"),
      allowedTools: z7.array(z7.string()).optional().describe("List of allowed tool names"),
      headers: z7.record(z7.string(), z7.string()).optional().describe("Custom headers to send"),
      authorization: z7.string().optional().describe("Authorization header value")
    })
  )
);
...
var webSearchArgsSchema = lazySchema3(
  () => zodSchema3(
    z8.object({
      allowedDomains: z8.array(z8.string()).max(5).optional(),
      excludedDomains: z8.array(z8.string()).max(5).optional(),
...
var xSearchArgsSchema = lazySchema4(
  () => zodSchema4(
    z9.object({
      allowedXHandles: z9.array(z9.string()).max(10).optional(),
      excludedXHandles: z9.array(z9.string()).max(10).optional(),
      fromDate: z9.string().optional(),
      toDate: z9.string().optional(),
      enableImageUnderstanding: z9.boolean().optional(),
      enableVideoUnderstanding: z9.boolean().optional()
    })
  )
);
...
var xSearchToolFactory = createProviderToolFactoryWithOutputSchema4({
  id: "xai.x_search",
  inputSchema: lazySchema4(() => zodSchema4(z9.object({}))),
...
var codeExecutionOutputSchema = z10.object({
  output: z10.string().describe("the output of the code execution"),
  error: z10.string().optional().describe("any error that occurred")
});
...
var viewImageOutputSchema = z11.object({
  description: z11.string().describe("description of the image"),
  objects: z11.array(z11.string()).optional().describe("objects detected in the image")
});
...
var viewXVideoOutputSchema = z12.object({
  transcript: z12.string().optional().describe("transcript of the video"),
  description: z12.string().describe("description of the video content"),
  duration: z12.number().optional().describe("duration in seconds")
});
